...
public class StockController {
    ...
    /**
     * To create a autowire for the rest template, we need to create a config file.
     */
    @Autowired
    ...
    {
        ResponseEntity<List<String>> quoteResponse = restTemplate.exchange("http://dbservice/rest/db/" + userName, HttpMethod.GET, null,
